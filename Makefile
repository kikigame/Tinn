...
src/dungeon.o : src/dungeon.cpp src/action.hpp src/appraise.hpp src/bonus.hpp src/characteristic.hpp src/chargen.hpp src/coord.hpp src/damage.hpp src/dungeon.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/player.hpp src/ref.hpp src/renderable.hpp src/role.hpp src/slots.hpp src/terrain.hpp src/time.hpp src/zone.hpp 
...
src/monsterType.o : src/monsterType.cpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/itemholder.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/movement.hpp src/optionalRef.hpp src/random.hpp src/ref.hpp src/religion.hpp src/renderable.hpp src/role.hpp src/slots.hpp src/time.hpp src/zone.hpp 
...
src/player.o : src/player.cpp src/action.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/dungeon.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/player.hpp src/ref.hpp src/religion.hpp src/renderable.hpp src/slots.hpp src/time.hpp src/zone.hpp 
