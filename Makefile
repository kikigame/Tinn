...
ofiles : src/action.o src/adjectives.o src/appraise.o src/bonus.o src/characteristic.o src/chargen.o src/coord.o src/damage.o src/dungeon.o src/encyclopedia.o src/equippable.o src/geometry.o src/item.o src/itemholder.o src/items.o src/itemType.o src/level.o src/levelFactory.o src/main.o src/mobile.o src/monster.o src/monsterFactory.o src/monsterIntrinsics.o src/monsterType.o src/output.o src/output_curses.o src/output_term.o src/player.o src/quest.o src/religion.o src/role.o src/shop.o src/shopkeeper.o src/shrine.o src/slots.o src/spaceZone.o src/terrain.o src/time.o src/transport.o 

	$(CXX)  src/action.o src/adjectives.o src/appraise.o src/bonus.o src/characteristic.o src/chargen.o src/coord.o src/damage.o src/dungeon.o src/encyclopedia.o src/equippable.o src/geometry.o src/item.o src/itemholder.o src/items.o src/itemType.o src/level.o src/levelFactory.o src/main.o src/mobile.o src/monster.o src/monsterFactory.o src/monsterIntrinsics.o src/monsterType.o src/output.o src/output_curses.o src/output_term.o src/player.o src/quest.o src/religion.o src/role.o src/shop.o src/shopkeeper.o src/shrine.o src/slots.o src/spaceZone.o src/terrain.o src/time.o src/transport.o  -Wall -g -std=c++11 $(CXXLINK) -o tinn

# Windown port 
tinn.exe : Makefile clean 
	CXX="$(WINCXX)" make -k ofiles && \
	$(WINCXX)  src/action.o src/adjectives.o src/appraise.o src/bonus.o src/characteristic.o src/chargen.o src/coord.o src/damage.o src/dungeon.o src/encyclopedia.o src/equippable.o src/geometry.o src/item.o src/itemholder.o src/items.o src/itemType.o src/level.o src/levelFactory.o src/main.o src/mobile.o src/monster.o src/monsterFactory.o src/monsterIntrinsics.o src/monsterType.o src/output.o src/output_curses.o src/output_term.o src/player.o src/quest.o src/religion.o src/role.o src/shop.o src/shopkeeper.o src/shrine.o src/slots.o src/spaceZone.o src/terrain.o src/time.o src/transport.o  -Wall -g -std=c++11 $(CXXLINK) -o tinn.exe
...
src/item.o : src/item.cpp src/action.hpp src/bonus.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/materialType.hpp src/optionalRef.hpp src/renderable.hpp src/slots.hpp 
...
src/monsterIntrinsics.o : src/monsterIntrinsics.cpp src/action.hpp src/bonus.hpp src/damage.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/materialType.hpp src/monsterIntrinsics.hpp src/movement.hpp src/optionalRef.hpp src/renderable.hpp src/slots.hpp src/terrain.hpp 
	$(CXX) src/monsterIntrinsics.cpp -c -Wall -g -std=c++11 -o src/monsterIntrinsics.o -finput-charset=utf8 -fexec-charset=utf8

src/monsterType.o : src/monsterType.cpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/itemholder.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/movement.hpp src/optionalRef.hpp src/quest.hpp src/random.hpp src/ref.hpp src/religion.hpp src/renderable.hpp src/role.hpp src/slots.hpp src/time.hpp src/zone.hpp 
