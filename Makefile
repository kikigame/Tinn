...
src/appraise.o : src/appraise.cpp src/action.hpp src/appraise.hpp src/beitude.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/ref.hpp src/renderable.hpp src/slots.hpp src/time.hpp src/zone.hpp 
...
src/chess.o : src/chess.cpp src/coord.hpp src/random.hpp 
	$(CXX) src/chess.cpp -c -Wall -g -std=c++11 -o src/chess.o -finput-charset=utf8 -fexec-charset=utf8
...
src/monsterIntrinsics.o : src/monsterIntrinsics.cpp src/action.hpp src/beitude.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/ref.hpp src/renderable.hpp src/slots.hpp src/terrain.hpp src/time.hpp src/zone.hpp 
	$(CXX) src/monsterIntrinsics.cpp -c -Wall -g -std=c++11 -o src/monsterIntrinsics.o -finput-charset=utf8 -fexec-charset=utf8

src/monstermutation.o : src/monstermutation.cpp src/bonus.hpp src/damage.hpp src/materialType.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/renderable.hpp src/terrain.hpp 
...
src/output_curses.o : src/output_curses.cpp src/args.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/dungeon.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemholder.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/player.hpp src/ref.hpp src/renderable.hpp src/slots.hpp src/time.hpp src/zone.hpp 
...
src/shrine.o : src/shrine.cpp src/action.hpp src/beitude.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/geometry.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/player.hpp src/random.hpp src/ref.hpp src/religion.hpp src/renderable.hpp src/shrine.hpp src/slots.hpp src/time.hpp src/zone.hpp 
...
src/spaceZone.o : src/spaceZone.cpp src/action.hpp src/beitude.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/geometry.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/ref.hpp src/renderable.hpp src/slots.hpp src/spaceZone.hpp src/terrain.hpp src/time.hpp src/zone.hpp 
	$(CXX) src/spaceZone.cpp -c -Wall -g -std=c++11 -o src/spaceZone.o -finput-charset=utf8 -fexec-charset=utf8

src/target.o : src/target.cpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemholder.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/random.hpp src/ref.hpp src/religion.hpp src/renderable.hpp src/slots.hpp src/target.hpp src/time.hpp src/zone.hpp 
	$(CXX) src/target.cpp -c -Wall -g -std=c++11 -o src/target.o -finput-charset=utf8 -fexec-charset=utf8

src/terrain.o : src/terrain.cpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemholder.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/random.hpp src/ref.hpp src/renderable.hpp src/slots.hpp src/terrain.hpp src/time.hpp src/zone.hpp 
