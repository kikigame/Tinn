...
ofiles : src/action.o src/adjectives.o src/alien.o src/appraise.o src/bonus.o src/characteristic.o src/chargen.o src/coord.o src/damage.o src/dreamscape.o src/dungeon.o src/encyclopedia.o src/equippable.o src/fruit.o src/gardenZone.o src/geometry.o src/item.o src/itemholder.o src/items.o src/itemType.o src/level.o src/levelFactory.o src/main.o src/mobile.o src/monster.o src/monsterFactory.o src/monsterIntrinsics.o src/monstermutation.o src/monsterType.o src/output.o src/output_curses.o src/output_fifos.o src/output_term.o src/player.o src/polymorph.o src/quest.o src/religion.o src/role.o src/sense.o src/shop.o src/shopkeeper.o src/shrine.o src/slots.o src/spaceZone.o src/target.o src/terrain.o src/time.o src/transport.o src/wish.o 
	...
	$(CXX)  src/action.o src/adjectives.o src/alien.o src/appraise.o src/bonus.o src/characteristic.o src/chargen.o src/coord.o src/damage.o src/dreamscape.o src/dungeon.o src/encyclopedia.o src/equippable.o src/fruit.o src/gardenZone.o src/geometry.o src/item.o src/itemholder.o src/items.o src/itemType.o src/level.o src/levelFactory.o src/main.o src/mobile.o src/monster.o src/monsterFactory.o src/monsterIntrinsics.o src/monstermutation.o src/monsterType.o src/output.o src/output_curses.o src/output_fifos.o src/output_term.o src/player.o src/polymorph.o src/quest.o src/religion.o src/role.o src/sense.o src/shop.o src/shopkeeper.o src/shrine.o src/slots.o src/spaceZone.o src/target.o src/terrain.o src/time.o src/transport.o src/wish.o  -Wall -g -std=c++11 $(CXXLINK) -o tinn

# Windown port 
tinn.exe : Makefile clean 
	CXX="$(WINCXX)" make -k ofiles && \
	$(WINCXX)  src/action.o src/adjectives.o src/alien.o src/appraise.o src/bonus.o src/characteristic.o src/chargen.o src/coord.o src/damage.o src/dreamscape.o src/dungeon.o src/encyclopedia.o src/equippable.o src/fruit.o src/gardenZone.o src/geometry.o src/item.o src/itemholder.o src/items.o src/itemType.o src/level.o src/levelFactory.o src/main.o src/mobile.o src/monster.o src/monsterFactory.o src/monsterIntrinsics.o src/monstermutation.o src/monsterType.o src/output.o src/output_curses.o src/output_fifos.o src/output_term.o src/player.o src/polymorph.o src/quest.o src/religion.o src/role.o src/sense.o src/shop.o src/shopkeeper.o src/shrine.o src/slots.o src/spaceZone.o src/target.o src/terrain.o src/time.o src/transport.o src/wish.o  -Wall -g -std=c++11 $(CXXLINK) -o tinn.exe
...
src/alien.o : src/alien.cpp src/alien.hpp src/optionalRef.hpp src/random.hpp src/religion.hpp src/renderable.hpp src/terrain.hpp 
	$(CXX) src/alien.cpp -c -Wall -g -std=c++11 -o src/alien.o -finput-charset=utf8 -fexec-charset=utf8
...
src/fruit.o : src/fruit.cpp src/action.hpp src/beitude.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/random.hpp src/ref.hpp src/renderable.hpp src/sense.hpp src/slots.hpp src/time.hpp src/zone.hpp 
	$(CXX) src/fruit.cpp -c -Wall -g -std=c++11 -o src/fruit.o -finput-charset=utf8 -fexec-charset=utf8
...
src/gardenZone.o : src/gardenZone.cpp src/action.hpp src/beitude.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/gardenZone.hpp src/geometry.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/random.hpp src/ref.hpp src/religion.hpp src/renderable.hpp src/sense.hpp src/slots.hpp src/terrain.hpp src/time.hpp src/zone.hpp 
	$(CXX) src/gardenZone.cpp -c -Wall -g -std=c++11 -o src/gardenZone.o -finput-charset=utf8 -fexec-charset=utf8
...
src/output_fifos.o : src/output_fifos.cpp src/args.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/dungeon.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemholder.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/player.hpp src/ref.hpp src/renderable.hpp src/sense.hpp src/slots.hpp src/time.hpp src/zone.hpp 
	$(CXX) src/output_fifos.cpp -c -Wall -g -std=c++11 -o src/output_fifos.o -finput-charset=utf8 -fexec-charset=utf8
...
src/sense.o : src/sense.cpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/dungeon.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemholder.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/player.hpp src/random.hpp src/ref.hpp src/religion.hpp src/renderable.hpp src/sense.hpp src/slots.hpp src/time.hpp src/zone.hpp 
	$(CXX) src/sense.cpp -c -Wall -g -std=c++11 -o src/sense.o -finput-charset=utf8 -fexec-charset=utf8
...
src/wish.o : src/wish.cpp src/action.hpp src/appraise.hpp src/beitude.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/ref.hpp src/renderable.hpp src/sense.hpp src/slots.hpp src/time.hpp src/wish.hpp src/zone.hpp 
	$(CXX) src/wish.cpp -c -Wall -g -std=c++11 -o src/wish.o -finput-charset=utf8 -fexec-charset=utf8
