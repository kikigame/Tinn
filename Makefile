...
src/fruit.o : src/fruit.cpp src/action.hpp src/bonus.hpp src/characteristic.hpp src/coord.hpp src/damage.hpp src/equippable.hpp src/graphsearch.hpp src/hasAdjectives.hpp src/itemTypes.hpp src/itemholder.hpp src/items.hpp src/iterable.hpp src/level.hpp src/materialType.hpp src/monster.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/optionalRef.hpp src/output.hpp src/player.hpp src/random.hpp src/ref.hpp src/renderable.hpp src/slots.hpp src/time.hpp src/zone.hpp 
...
src/monstermutation.o : src/monstermutation.cpp src/bonus.hpp src/damage.hpp src/materialType.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp src/renderable.hpp 
