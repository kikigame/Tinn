...
src/monstermutation.o : src/monstermutation.cpp src/bonus.hpp src/damage.hpp src/materialType.hpp src/monsterIntrinsics.hpp src/monsterType.hpp src/monstermutation.hpp src/movement.hpp 
