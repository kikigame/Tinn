...
public:
  ...
  virtual std::shared_ptr<monsterAbilities> wrap(monsterIntrinsics &a) = 0;
};
...
class delegatingAbilities : public monsterAbilities {
 private:
  monsterAbilities &d_;
 public:
  delegatingAbilities(monsterAbilities &delegate) : d_(delegate) {}
...
class vampireAbilities : public delegatingAbilities {
 public:
  vampireAbilities(monsterAbilities &delegate) : delegatingAbilities(delegate) {}
...
class cyberAbilities : public delegatingAbilities {
 public:
  cyberAbilities(monsterAbilities &delegate) : delegatingAbilities(delegate) {}
...
class wereAbilities : public delegatingAbilities {
 public:
  wereAbilities(monsterAbilities &delegate) : delegatingAbilities(delegate) {}
...
public:
  ...
  virtual std::shared_ptr<monsterAbilities> wrap(monsterIntrinsics &a) {
...
mutation &mutationFactory::operator[](const mutationType &t) {
  return *map_[t];
};
